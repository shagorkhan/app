...
const HomeScreen = () => {
    ...
    const boxData = [
      { id: 1, logo: require('../../assets/livecasino.png'), name: 'Live Casino' },
      ...
      { id: 6, logo: require('../../assets/videopoker.png'), name: 'Video Poker' },
      { id: 7, logo: require('../../assets/lottery.png'), name: 'Lottery' },
      { id: 8, logo: require('../../assets/cricketlive.png'), name: 'Cricket Live' },
  ...
  //const boxWidth = Math.min(maxBoxWidth, width * 0.45); // Adjust the factor as needed
    ...
    <ScrollView>
          ...
          <View style={styles.row}>
            {boxData.slice(0, 4).map((box) => (
              <TouchableOpacity key={box.id} style={[styles.box]}>
                ...
                <LinearGradient
                  colors={['rgba(224, 223, 223, 0)', 'rgba(224, 223, 223, 0)', '#000000']}
      ...
      <View style={styles.twoBoxesContainer}>
        <Text style={{fontSize: 18,fontWeight: 'bold', marginLeft: 10}}>Live Games</Text>
      ...
      <View style={styles.twoBoxesContainer}>
        <Text style={{fontSize: 18,fontWeight: 'bold', marginLeft: 10}}>Favorite's Games</Text>
        <ScrollView horizontal={true}>
        <TouchableOpacity style={styles.twoBoxes}>
      ...
      <View style={styles.twoBoxesContainer}>
        <Text style={{fontSize: 18,fontWeight: 'bold', marginLeft: 10}}>Feature's Games</Text>
        <ScrollView horizontal={true}>
        <TouchableOpacity style={styles.twoBoxes}>
...
const styles = StyleSheet.create({
    container: {
      ...
      box: {
        width: width/4-20, // Adjust the width of the box
        height:width/4-20,
        ...
        //position: 'relative', // To position the boxName text
      },
      boxLogo: {
        flex: 1,
