...
const TurnoverHistoryPendingCard = ({
  title,
  targetAmount,
  completedAmount,
  date,
  ...
  return (
    ...
    >
      <View style={{}}>
          <Text numberOfLines={1} ellipsizeMode="tail" style={{ fontSize: 16, fontWeight: 400, color: "#000000",marginBottom:7 }}>
            {title}
          </Text>
...
export default TurnoverHistoryPendingCard;
